...
function cssFor(theme, wallpaperUrl) {
  ...
  const mainWallpaper = theme.wallpaperScope === "main" ? `#root>:first-child{background:linear-gradient(rgb(255 255 255/.40),rgb(255 255 255/.40))${wallpaper}!important;background-attachment:fixed!important}#root>:first-child>:not(aside):not([class*=sidebar]):not([class*=Sidebar]),#root>:first-child>:not(aside):not([class*=sidebar]):not([class*=Sidebar]) :is(main,[class*=main-content],[class*=MainContent],[class*=content-area],[class*=ContentArea],[class*=workbench],[class*=Workbench],.wb-home-page,.automation-main-page,.shared-files-list,.knowledge-base-panel,.discover-panel-page,.project-detail-view,.project-detail-view__body,.project-detail-view__main,.project-detail-view__content){background-color:transparent!important}` : "";
