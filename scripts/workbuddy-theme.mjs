...
function cssFor(theme, wallpaperUrl) {
  ...
  const mainWallpaper = theme.wallpaperScope === "main" ? `#root>:first-child{position:relative!important;isolation:isolate!important}#root>:first-child:before{content:"";position:absolute;z-index:-1;inset:0;pointer-events:none;background:linear-gradient(rgb(255 255 255/.72),rgb(255 255 255/.72))${wallpaper}!important}` : "";
